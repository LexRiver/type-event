...
test('multiparams', function () { return __awaiter(void 0, void 0, void 0, function () {
    var e, sum;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                e = new TypeEvent_1.TypeEvent();
                sum = 0;
                e.subscribe(function (x, y, z) {
                    console.log('x=', x, 'y=', y, 'z=', z);
                    sum = x + y + z;
                });
                return [4 /*yield*/, e.triggerAsync(100, 200, 300)];
            case 1:
                _a.sent();
